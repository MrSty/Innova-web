    ...
    return (
        <div id="AboutPrd">
            <div className="flex flex-col justify-end lg:h-screen space-y-10 xl:space-y-0 mt-32 lg:mx-14 xl:mx-0 xl:ml-16 lg:mt-[5.3rem]">
                ...
                <div className="h-1/3 flex flex-col lg:items-center lg:justify-center">
                    <div className="lg:w-[45%] rounded-[4rem] bg-white shadow-gray-500 shadow-xl py-10 px-10 flex flex-col space-y-5">
                        <h2 className="text-[1.3rem] font-bold">ABOUT THE PRODUCT</h2>
                        <p className="mx-[5.7rem] text-justify text-gray-500">The Magic Box is not just a screen protector; it&apos;s a shield of innovation. Using
