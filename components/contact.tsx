        ...
        <div className="bg-primary md:flex lg:hidden flex-col pt-5 space-y-5 pb-5 rounded-t-[2rem]">
            ...
            <div className="flex flex-row items-center justify-center space-x-20">
                <a href="https://www.facebook.com/" target="_blank">
                    <div className="flex flex-col text-primary bg-white items-center p-2 rounded-2xl">
                ...
                <a href="https://www.instagram.com/" target="_blank">
                    <div className="flex flex-col text-primary bg-white items-center p-2 rounded-xl">
                ...
                <a href="https://www.amazon.com/" target="_blank">
                    <div className="flex flex-col text-primary bg-white items-center p-2 rounded-xl px-3">
